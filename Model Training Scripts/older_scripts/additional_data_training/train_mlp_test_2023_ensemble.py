...
def build_datasets(args):
    ...
    # --- NEW: resolve time indices by year (if requested) ---
    ...
    common = dict(
        ...
        return_coords=False,
        peat_mask_source="smap_wtd_SE_Asia_t32_p32.zarr",
        coords_source="smap_wtd_SE_Asia_t32_p32.zarr",  # if you want coords forced too
    )
    ...
    if test_time_index is not None:
        ...
        common_test["t_end_index"] = test_t_end_index   # <-- IMPORTANT
