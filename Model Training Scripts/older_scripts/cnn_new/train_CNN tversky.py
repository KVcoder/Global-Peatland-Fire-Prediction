...
def describe_environment(args, device):
    ...
    print_diagnostic_item("SMAP", _detect_storage_type(args.smap_zarr), indent=1)
...
def main():
    ...
    if args.quick_test:
        ...
        args.limit_train_samples = min(args.limit_train_samples or 0, 512)
    ...
    history: Dict[str, Any] = {
        ...
        "val": {
            ...
            "support": [],
            "per_horizon": {
                int(h): {"epoch": [], "accuracy": [], "precision": [], "recall": [], "f1": []}
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_loader is not None:
            ...
            for h, m in val_metrics["per_horizon"].items():
                ...
                per_h = vh["per_horizon"].setdefault(
                    h_int, {"epoch": [], "accuracy": [], "precision": [], "recall": [], "f1": []}
                )
        ...
        if epoch == args.epochs and test_loader is not None:
            ...
            print_diagnostic_header("Final test metrics")
            print(
                f"[Test] loss={test_loss:.6f}, "
                f"acc={test_metrics['accuracy']:.4f}, "
                f"prec={test_metrics['precision']:.4f}, "
