...
def build_feature_names_from_dataset(args, ds) -> list[str]:
    ...
    # Case A: dataset returns separate time dim: (B,T,C,H,W)
    ...
    # Case B: dataset already flattened to channels: (B,F,H,W)
